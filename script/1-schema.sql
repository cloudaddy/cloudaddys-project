...
DROP SCHEMA IF EXISTS `cloudaddy` ;
CREATE SCHEMA IF NOT EXISTS `cloudaddy` DEFAULT CHARACTER SET latin1 ;
USE `cloudaddy` ;

-- -----------------------------------------------------
-- Table `cloudaddy`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`customers` (
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees1`
    ...
    REFERENCES `cloudaddy`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges1`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `cloudaddy`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `cloudaddy`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers1`
    ...
    REFERENCES `cloudaddy`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status1`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `cloudaddy`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `cloudaddy`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`products` (
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `cloudaddy`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers1`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `cloudaddy`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `cloudaddy`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions1`
    ...
    REFERENCES `cloudaddy`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`sales_reports` (
...
-- -----------------------------------------------------
-- Table `cloudaddy`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cloudaddy`.`strings` (
