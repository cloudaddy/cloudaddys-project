...
public interface ProductDao {
	...
	ArrayList<Product> getProducts(DataSource dataSource, int id) throws SQLException;
	void saveReport(DataSource dataSource,int supplierId, int userId, String company, 
			String rName,ArrayList<Product> products, ArrayList<Inventory_Transaction> it) throws SQLException;
